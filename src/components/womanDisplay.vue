<template>
      <div class="container">
        ...
        <div class="product">
          <div class="gallery">
            <img src="../assets/woman_clothes-removebg-preview.png" alt="Product Image">
          </div>
            <div class="product-details">
              <h2 class="product-title">Lock and Love Women's Removable Hooded Faux Leather Moto Biker Jacket</h2>
